...
@section('content')
    <div class="container-fluid bg-dark text-light py-5 rounded">
                ...
                <div class="card bg-white text-dark">
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item"><strong>Foto:</strong> <img src="{{ $categoria->icone }}"
                                    alt="{{ $categoria->nome }}" width="100"></li>
